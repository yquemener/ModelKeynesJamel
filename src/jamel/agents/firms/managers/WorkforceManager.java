...
public class WorkforceManager extends JamelObject {
	...
	/** The default wage. */
	private static final double defaultWage = 3000; // TODO: Should be a parameter.
	...
	private float normalVacancyRate = 0.03f;

	/** The wage proposed on the labor market. */
	private Double offeredWage ;
	 ...
	 */
	private double getVacanciesRate() {
	...
	private void updateWage() {
		...
		this.offeredWage = Math.max( this.offeredWage,Circuit.getminimumWage()) ;		
