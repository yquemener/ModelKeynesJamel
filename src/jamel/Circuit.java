...
public class Circuit extends JamelObject {
	 ...
	 */
	public static Firm getRandomFirm(ProductionType type) {
		return circuit.firms.getRandomFirm(type);
	}
	 ...
	 * @param sector the type of production of the firm.
	 * @return a collection of firms.
	 */
	public static Collection<? extends Firm> getRandomFirms(int i, ProductionType sector) {
		return circuit.firms.getRandomFirms(i,sector);
	}
	...
	private void setParameters(String[] parameters) {
		for(final String line:parameters) {
			...
			if (parameter[0].equals("minimum wage")) this.minimumWage=Integer.parseInt(parameter[1]);
			else if (parameter[0].equals("range")) simulator.zoom(Integer.parseInt(parameter[1]));
